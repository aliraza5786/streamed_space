    ...
    <div class="flex gap-3 flex-auto h-full overflow-x-auto w-full ">
        <div class="w-full h-full bg-white/90 rounded-lg overflow-y-auto flex-col flex  ">
            ...
            <!-- <KanbanBoard :onAddTicket="() => {
                ...
                title: 'Start planing your project ',
                description: 'Add milestones, manage sprints and create huddles',
                icon: emptystateIcon,
            ...
            <GenericTable v-if="currentView == 'list' && peopleBy == 'milestone'" :columns="[
            ...
            <GenericTable v-else-if="currentView == 'list' && peopleBy == 'sprints'" :columns="[
                { label: 'Department', accessor: 'department' },
                { label: 'Team', accessor: 'team' },
                { label: 'Members Count', accessor: 'member', postfix: helpCircle },
                { label: 'Status', accessor: 'status', postfix: arrowDown },
            ]" :tableData="tableData" :perPage="9" />
            <GenericTable v-else-if="currentView == 'list' && peopleBy == 'huddles'" :columns="[
...
// import ProfilePanel from '../components/feature/ProfilePanel.vue';
import ProgressBar from '../components/ui/ProgressBar.vue';
import Collaborators from '../components/ui/Collaborators.vue';
import { useWorkspaceStore } from '../stores/workspace';
// import Dropdown from '../components/ui/Dropdown.vue';
// import milestoneIcon from "../assets/icons/milestones.svg"
// import sprintIcon from "../assets/icons/Sprints.svg"
// import huddleIcon from "../assets/icons/huddels.svg"
...
// import emptystateIcon from "../assets/empty-state/plan.svg"
...
const peopleBy = ref<'milestone' | 'sprints' | 'huddles'>('milestone');
// const peopleByOptions = [
//     { label: 'milestones', value: 'milestone', prefix: milestoneIcon },
//     { label: 'sprints', value: 'sprints', prefix: sprintIcon },
//     { label: 'huddles', value: 'huddles', prefix: huddleIcon },
// ]
