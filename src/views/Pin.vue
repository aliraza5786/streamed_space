    ...
    <div class="flex gap-3 flex-auto h-full overflow-x-auto w-full ">
        <div class="w-full h-full bg-white/90 rounded-lg overflow-y-auto flex-col flex  ">
            <div class="header px-4 py-3 border-b  border-border-gray flex items-center justify-between gap-1">
                <!-- <Dropdown v-model="pinBy" :options="pinByOptions" variant="secondary" /> -->
            ...
            <!-- <KanbanBoard :onAddTicket="() => {
                ...
                title: 'Start creating your pins',
                description: 'Create pins and add your ideas into the related pins.',
                icon: emptystateIcon,
            ...
            <GenericTable v-if="currentView == 'list' && pinBy == 'general'" :columns="[
            ...
            <GenericTable v-else-if="currentView == 'list' && pinBy == 'design'" :columns="[
                { label: 'Department', accessor: 'department' },
                { label: 'Team', accessor: 'team' },
                { label: 'Members Count', accessor: 'member', postfix: helpCircle },
                { label: 'Status', accessor: 'status', postfix: arrowDown },
            ]" :tableData="tableData" :perPage="9" />
            <GenericTable v-else-if="currentView == 'list' && pinBy == 'role'" :columns="[
...
// import emptystateIcon from "../assets/empty-state/pin.svg"
...
const pinBy = ref<'general' | 'design' | 'role'>('general');
// const pinByOptions = [
//     { label: 'General', value: 'general', prefix: processIcon },
//     { label: 'Design Ideas', value: 'design', prefix: designIcon },
//     { label: 'Add New Board', value: 'add new', prefix: Plus },
