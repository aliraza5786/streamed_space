    ...
    <div class="flex gap-3 flex-auto h-full overflow-x-auto w-full ">
        <div class="w-full h-full bg-white/90 rounded-lg overflow-y-auto flex-col flex  ">
            <div class="header px-4 py-3 border-b  border-border-gray flex items-center justify-between gap-1">
                <!-- <Dropdown v-model="processBy" :options="processByOptions"  variant="secondary" /> -->
            ...
            <!-- <KanbanBoard :onAddTicket="() => {
                ...
                description: 'Define your work process here',
                icon: emptystateIcon,
            ...
            <GenericTable v-if="currentView == 'list' && processBy == 'main'" :columns="[
            ...
            <GenericTable v-else-if="currentView == 'list' && processBy == 'design'" :columns="[
                { label: 'Department', accessor: 'department' },
                { label: 'Team', accessor: 'team' },
                { label: 'Members Count', accessor: 'member', postfix: helpCircle },
                { label: 'Status', accessor: 'status', postfix: arrowDown },
            ]" :tableData="tableData" :perPage="9" />
            <GenericTable v-else-if="currentView == 'list' && processBy == 'role'" :columns="[
...
// import processIcon from "../assets/icons/main-process.svg"
// import designIcon from "../assets/icons/design-process.svg"
...
// import DevliveryProcess from '../assets/icons/devlivery-process.svg';
// import DevelopmentProcess from '../assets/icons/development-process.svg';
// import Onboarding from '../assets/icons/onboarding.svg';
// import emptystateIcon from "../assets/empty-state/process.svg"
defineProps<{
    template: `<div class="flex">
    <img src=""/>
    <div class="flex flex-col gap-2">
    <h3 class="text-sm font-medium text-text-primary">Olivia Rhye</h3>
    </div>
    </div>`
}>()
...
const processBy = ref<'main' | 'design' | 'role'>('main');
// const processByOptions = [
//     { label: 'Main Process', value: 'main', prefix: processIcon },
//     { label: 'Design Process', value: 'design', prefix: designIcon },
//     { label: 'Delivery Process', value: 'delivery', prefix: DevliveryProcess },
//     { label: 'Development Process', value: 'development', prefix: DevelopmentProcess },
//     { label: 'Project Onboarding Process', value: 'onboarding', prefix: Onboarding },
// ]
